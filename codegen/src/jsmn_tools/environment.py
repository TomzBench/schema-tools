...
from jsmn_tools.jsmn.descriptor import Descriptors, Key
from jsmn_tools.jsmn.filters import filters, tests
from jsmn_tools.jsmn.flatten import flatten_with_resolver
from jsmn_tools.jsmn.ir import CDecl
...
class Environment:
    ...
    def extend(
        ...
        runtime_dir = Path(__file__).resolve().parent / "jsmn" / "runtime"
        runtime_mapping = {
